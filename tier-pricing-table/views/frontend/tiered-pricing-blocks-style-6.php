...
<?php if ( ! empty( $price_rules ) ) : ?>
	...
	<div class="tiered-pricing-wrapper">
		...
		<div class="tiered-pricing-blocks tiered-pricing-blocks--styled tiered-pricing-blocks--style-6 <?php echo ( isset( $settings['compact_layout'] ) && $settings['compact_layout'] === 'yes' ) ? 'tiered-pricing-blocks--slim' : ''; ?>"
	...
	<style>
		...
		<?php echo esc_attr('#' . $id); ?> .tiered-pricing--active {
			box-shadow: inset 0 0 0 1px <?php echo esc_attr($settings['active_tier_color']); ?>, 0 0 0 1px <?php echo esc_attr($settings['active_tier_color']); ?> !important;
		}
