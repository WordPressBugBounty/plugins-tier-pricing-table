...
<?php if ( ! empty( $pricing_rule->getRules() ) ) : ?>
	...
	<div class="tiered-pricing-wrapper">
		...
		<div class="tiered-pricing-table tiered-pricing-table--styled tiered-pricing-table--style-1 <?php echo ( isset( $settings['slim_design'] ) && $settings['slim_design'] === 'yes' ) ? 'tiered-pricing-table--styled-slim' : ''; ?>"
					...
					<?php if ( $settings['discount_column_title'] ) : ?>
						...
						<div>
							<?php if ( $discountAmount > 0 ) : ?>
								<span class="tiered-pricing-table-row-discount"><?php echo esc_attr( round( $discountAmount,
											2 ) ); ?> %</span>
							<?php else : ?>
	...
	<style>
		...
		.tiered-pricing--active {
			background-color: <?php echo esc_attr($settings['active_tier_color']); ?>15 !important; /* 15 is hex opacity for roughly 8% */
			border-left: 4px solid <?php echo esc_attr($settings['active_tier_color']); ?> !important;
		}
	</style>
<?php endif; ?>
