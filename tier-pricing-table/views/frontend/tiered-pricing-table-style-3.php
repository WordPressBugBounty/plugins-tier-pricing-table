...
<?php if ( ! empty( $pricing_rule->getRules() ) ) : ?>
	...
	<div class="tiered-pricing-wrapper">
		...
		<div class="tiered-pricing-table tiered-pricing-table--styled tiered-pricing-table--style-3 <?php echo (isset($settings['slim_design']) && $settings['slim_design'] === 'yes') ? 'tiered-pricing-table--styled-slim' : ''; ?>"
