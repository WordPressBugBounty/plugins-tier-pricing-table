...
<?php if ( ! empty( $price_rules ) ) : ?>
	...
	<div class="tiered-pricing-wrapper">
		...
		<div class="tiered-pricing-blocks tiered-pricing-blocks--styled tiered-pricing-blocks--style-7 <?php echo ( isset( $settings['compact_layout'] ) && $settings['compact_layout'] === 'yes' ) ? 'tiered-pricing-blocks--slim' : ''; ?>"
